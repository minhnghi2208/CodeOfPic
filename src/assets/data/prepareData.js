...
export const MyPrepareStory = [
  {
    ...
    title: "Ý tưởng",
    decription:
      "Hôm này anh nảy ra ý tưởng trong lúc đang về quê, anh nghĩ sẽ làm gì đó đặc biệt để tặng em mà sẽ không ai có, và anh nghĩ làm một website để lưu giữ hết những khoảnh khắc của chúng mình nè. ",
    date: "14/12/2025",
  },
  {
    picture: designStage,
    title: "Thiết kế",
    decription:
      "Hôm nay là ngày mà anh bắt đầu vào thực hiện ý tưởng nè, đây là giai đoạn đầu tiên, anh giành thời gian để thiết kế trang web nè.",
    date: "15/12/2025",
  },
  {
    picture: codingStage,
